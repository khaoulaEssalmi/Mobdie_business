                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <form id="general" method="POST" action="{{ route('general.update.general') }}">
                                ...
                                <div class="text-right mt-3">
                                    <button type="submit" class="btn btn-primary" name="button_clicked"
                                            value="save_changes">Save changes
                                    </button>&nbsp;
                            ...
                            <div class="card-body pb-2">
                                <form method="POST" action="{{ route('general.change_password') }}">
                                    ...
                                    <div class="text-right mt-3">
                                        ...
                                        <button type="submit" class="btn btn-default" name="button_clicked"
                                                value="cancel">Cancel
                                        </button>
                                    </div>
                                </form>
