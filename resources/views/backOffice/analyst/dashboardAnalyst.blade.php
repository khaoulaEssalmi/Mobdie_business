        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    ...
                    <h6 class="font-weight-normal mb-0" style="font-size: 20px !important; padding-top: 70px !important;">All systems are running smoothly {{ auth()->user()->name }} !
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <canvas id="order-chart" style="display: block; height: 158px; width: 316px;" width="395"
                            height="197" class="chartjs-render-monitor"></canvas>
                </div>
            </div>
        </div>
