...
@section("content-wrapper")
    ...
    <div class="cont">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-tale">
                    <div class="card-body" style="background-image: linear-gradient(45deg,#C368E5 , #D27FE2);">
                        <p class="mb-4" style="font-size: 20px;">Number of analysts</p>
                        <p class="fs-30 mb-2">
                            <span class="mr-2">{{ $analystCount }}</span>
