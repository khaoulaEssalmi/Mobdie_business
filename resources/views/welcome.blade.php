...
<head>
    ...
    <!-- animate css -->
    <link rel = "stylesheet" href = "{{asset("front")}}/resources/animate.css-main/animate.css">
    <!-- custom (main) css -->
    <link rel="stylesheet" href="{{asset("front")}}/css/main.css">
</head>
<style></style>
...
<header class = "header" id = "intro">
    ...
    <div class = "hero-div center container">
        <h1>Your online partner for exceptional projects and enlightened business advice.</h1>
        <p class = "animate__animated animate__fadeInUp animate__slow">
            Optimize your projects and boost your business with our expertise.</p>
        ...
        <div class = "row wow animate__animated animate__fadeInUp animate__slow">
            <div class = "faq-item">
                ...
                <div class = "faq-content">
                    <p class = "text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit nisi quis molestiae autem exercitationem sed, asperiores provident aut, quaerat illo ex reiciendis sapiente voluptas quisquam?</p>
                    <p class = "text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae, suscipit! Officiis architecto laboriosam harum officia!</p>
                </div>
            </div>
        ...
        <div class = "row owl-carousel owl-theme wow animate__animated animate__fadeInUp animate__slow">
            <div class = "testimonial-item">
                <div class = "testimonial-img">
                    <img src = "{{asset("front")}}/assets/test-1.jpg" alt = "">
                </div>
            ...
            <div class = "testimonial-item">
                <div class = "testimonial-img">
                    <img src = "{{asset("front")}}/assets/test-2.jpg" alt = "">
                </div>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta doloribus necessitatibus totam alias unde sint veritatis placeat beatae maiores odio?</p>
                <span>Someone's Name</span>
            </div>
            ...
            <div class = "testimonial-item">
                <div class = "testimonial-img">
                    <img src = "{{asset("front")}}/assets/test-3.jpg" alt = "">
                </div>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Soluta doloribus necessitatibus totam alias unde sint veritatis placeat beatae maiores odio?</p>
                <span>Someone's Name</span>
            </div>
    ...
    <div class = "container">
        ...
        <div class = "row wow animate__animated animate__fadeInUp animate__slow">
            ...
            <div class = "contact-right">
                ...
                <div>
                    <h2>Send Email</h2>
                    <p class = "text">design.diva@gmail.com</p>
                </div>
            </div>
        </div>
    </div>
...
<footer class = "footer center">
    <div class = "container">
        <p class = "text">Copyright &copy; Design.Diva Website | All Rights Reserved</p>
...
<!-- jQuery -->
<script src = "{{asset("front")}}/resources/jquery-3.5.1.js"></script>
<!-- magnific popup -->
...
<!-- wow js -->
<script src = "{{asset("front")}}/resources/WOW-master/dist/wow.js"></script>
<!-- custom js -->
